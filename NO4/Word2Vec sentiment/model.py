...
#导入模型
train_model = word2vec.Word2Vec.load('D:/project_python/ClassLearning/NO4/Word2Vec sentiment/train_model.model')
test_model = word2vec.Word2Vec.load('D:/project_python/ClassLearning/NO4/Word2Vec sentiment/test_model.model')
#计算词向量
...
def get_train_vec(x_train,x_test,train_model,test_model):
    ...
    #保存数据
    np.save('D:/project_python/ClassLearning/NO4/Word2Vec sentiment/train_vec.npy',train_vec)
    np.save('D:/project_python/ClassLearning/NO4/Word2Vec sentiment/test_vec.npy',test_vec)
